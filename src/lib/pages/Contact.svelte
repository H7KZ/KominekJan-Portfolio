	...
	<div class="w-4/5 max-w-6xl mt-32 px-5 py-3 rounded-xl border-4 bg-[#1d1d1d] border-[#cbff6a] flex flex-row justify-items-center gap-12 sm:px-10 sm:py-6 md:rounded-3xl md:border-8 md:px-28 md:py-20">
		<div class="w-full h-full flex flex-col items-start gap-4 lg:w-1/2">
			...
			<p class="font-op font-medium text-base text-grayWhite">
				I'm currently looking for new opportunities. If you're interested in working with me or
				hiring me, please contact me via email, Discord, LinkedIn or even Steam. Not so sure? No
				problem, we can discuss it. I'm always open to new ideas and opportunities.
			</p>
